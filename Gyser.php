...
<div class="topnav">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a class="active" href="Gyser.php">Gyser</a>
    </div>
  </div> 
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a class="active" href="Eventyr.php">Eventyr</a>
...
$find_videos = mysqli_query($conn, "SELECT * FROM hyper_videoes WHERE movie_type = 'Horror'");
...
function myFunction(id) {
  ...
  if (checkBox.checked == true) {
    window.location.href = 'ajax.php?id=' + id + '&back=Gyser' 
  } 
  else {
    window.location.href = 'ajax.php?id=' + id + '&back=Gyser' 
  }
